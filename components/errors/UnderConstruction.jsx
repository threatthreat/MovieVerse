    ...
    <>
      <div className="flex flex-col items-center w-full px-52 max-[1460px]:px-[5rem] max-[1250px]:px-[3rem]">
        <div className="w-full max-w-[96rem] h-screen flex items-center justify-between">
          <div className="max-[700px]:w-full z-10">
            <div className="flex w-full h-[3px] rounded-[25%] bg-[linear-gradient(45deg,#dac17b,#5bccbd,#70759e)]"></div>
            <div className="text-5xl text-[#eeeeee] font-['poppins'] mt-6 font-medium max-[700px]:text-center">Work in Progress</div>
            ...
            <div className="text-[#ffffffc2] w-full max-[700px]:flex max-[700px]:justify-center">
              <div className="max-w-[28rem] max-[700px]:text-center">Plot in Progress: We’re Crafting a New Movie Saga Just for You! So for the time being</div>
            </div>
            ...
            <div className="w-full max-[700px]:flex max-[700px]:justify-center max-[700px]:mt-4">
              <button onClick={() => push("/")} className="w-max h-max mt-5 hover:bg-slate-900 cursor-pointer duration-100 text-white px-4 py-2 backdrop-blur-md text-[14px] border-[1px] border-[#ffffff4b] rounded-xl flex gap-2 items-center">Go Back <span className="mt-[3px]"><FaArrowRight /></span></button>
            </div>

          </div>
          <div className="relative mt-4">
            <Image src={"/images/waifus/work in progress.png"} width={400} height={600} alt="waifu" className="max-[990px]:scale-x-[0.8] max-[990px]:scale-y-[0.8] max-[700px]:hidden" />
